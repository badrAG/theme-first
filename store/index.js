    ...
    return new Vuex.Store({
      state: ()=>{
        return {
          ...
          apps: [],
          token:  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdG9yZSI6eyJfaWQiOiI2NDc1YjM1MGU3NTI3MTIyYzc5M2JjOTkifSwic291cmNlIjoiVEhFTUVTIiwiaWF0IjoxNjg3NTE4ODEzLCJleHAiOjE3MTkwNTQ4MTN9.dZ3uYeKdzcCiztDQLPHt1xtNaFgmJVQ-ER80MWpTAPs',
          primary: {
            rgb: { r:0, g:0, b:0 },
            color: '#000000'
          },
