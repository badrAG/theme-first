    ...
    <div class="transition-all delay-300" :class="$store.state.showHeaderMenu ? 'to-right' : ''">
        <component :is="'style'">
            :root{ --primary-rgb: {{ rgb.r }}, {{rgb.g}}, {{ rgb.b }}; --primary-color: rgb(var(--primary-rgb)); 
                   --primary-text-rgb: {{ text_rgb.r }},{{ text_rgb.g  }}, {{ text_rgb.b }} ; --primary-text: rgb(var(--primary-text-rgb)); 
                   ...
                   --products-rgb: {{ products_rgb.r }},{{ products_rgb.g  }}, {{ products_rgb.b }} ; --products-color-bg: rgb(var(--products-rgb));          
                   ...
                   --products-comprice-rgb: {{ products_comprice_rgb.r }},{{ products_comprice_rgb.g  }}, {{ products_comprice_rgb.b }} ; --products-comprice-col: rgb(var(--products-comprice-rgb));          
            ...
            .products-bg {background-color: var(--products-color-bg);}
            ...
            .products-comprice-text-bg {color: var(--products-comprice-col);}
            ...
            .buynow-bg {background-color: var(--buynow-rgb);}
...
export default {
    ...
    async fetch(){
        ...
        this.text_rgb = this.$tools.hexToRgb(this.$settings.style.primary_text_color);
        ...
        this.products_rgb = this.$tools.hexToRgb(this.$settings.style.products_color);
        ...
        this.products_comprice_rgb = this.$tools.hexToRgb(this.$settings.style.products_comprice_color);
