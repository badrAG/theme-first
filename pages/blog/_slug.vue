          ...
          <div class="flex relative">
            <!-- slider left  -->
              <transition name="slideleft" v-if="$settings.sections.blog.sidebar.active">
                <!-- show slider content -->
                <div :class="showSideBar ? 'show':'hide'" class="w-80 fixed hidden h-full top-0 left-0 bottom-0 bg-white z-10 ">
                    ...
                    <!-- icons -->
                        <div class="mb-4">
                            <div class="flex items-center px-4" :class="$settings.sections.blog.sidebar.active? 'justify-between': 'justify-end'">
                                <div v-if="$settings.sections.blog.sidebar.active" class="rounded-full transition ease-linear delay-150 shadow hover:shadow-lg p-2 border-2 border-black" @click="showSideBar = true">
