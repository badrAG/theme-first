                    ...
                    <div class="mb-4">
                        <div class="flex items-center px-4" :class="$settings.sections.blog.sidebar.active? 'justify-between': 'justify-end'">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-md font-bold">{{ $settings.sections.blog.filter_text }}</span>
                            </div>
                            </div>
                            <!--  -->
                            <select class="cursor-pointer text-md font-bold sort-select bg-white w-40 px-3 py-1.5 rounded-full transition ease-linear delay-150 box-shadow scale outline-none border-2 bg-primary-border" v-model="params.sort">
