                    ...
                    <!-- icons -->
                        <div class="mb-4">
                            <div class="flex items-center px-4" :class="$settings.sections.blog.sidebar.active? 'justify-between': 'justify-end'">
                                <div v-if="$settings.sections.blog.sidebar.active" class="rounded-full transition ease-linear delay-150 box-shadow scale p-2 border-2 bg-primary-border" @click="showSideBar = true">
