<template>
  <div class="bg-white">
    <!-- <sections-collections01 v-if="$settings.sections.collections.active"></sections-collections01>  -->
    ...
    <!--  <sections-collections02 v-if="$settings.sections.collections1.active"></sections-collections02>  -->
