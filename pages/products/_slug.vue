                ...
                <div style="height: fit-content;" class="w-full lg:w-2/3 lg:sticky lg:top-6">
                    <div class="flex flex-wrap">
                        <div class="relative w-full slider md:mx-4">
                            ...
                            <!-- image -->
                            <button v-if="item.images.length > 1" class="box-shadow-xs mx-2 md:mx-3 absolute top-1/2 -left-0 transform -translate-y-1/2 p-3 md:p-4 bg-white transition-all ease-linear delay-150  rounded-full  hover-bg" @click="prev">
                            ...
                            <button v-if="item.images.length > 1" class="box-shadow-xs mx-2 md:mx-3 absolute top-1/2 -right-0 transform -translate-y-1/2 p-3 md:p-4 bg-white transition-all ease-linear delay-150 rounded-full hover-bg" @click="next">
                            ...
                            <div v-if="$settings.sections.products.add_to_wishlist.active">
                                <button v-if="$store.state.wishlist.find(i=>i._id==item._id)" @click="removeFromWishlist" title="Wishlist" class="box-shadow-xs bg-white rounded-full absolute z-10 top-0 right-0 m-2 md:m-3 p-3 md:p-4 transition-all ease-linear delay-150  hover-bg">
                                    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="heart" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 text-xs align-middle translate text-red"><path fill="currentColor" d="M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z"></path></svg>
                                </button>
                                <button v-else @click="addToWishlist" title="Wishlist" class="box-shadow-xs bg-white rounded-full absolute z-10 top-0 right-0 m-2 md:m-3 p-3 md:p-4 transition-all ease-linear delay-150 hover-bg">
