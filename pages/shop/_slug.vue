                    ...
                    <div :class="showSideBar ? 'show':'hide'" class="filters w-80 fixed hidden h-full top-0 left-0 bottom-0 bg-white z-50 overflow-y-auto">
                        ...
                        <div class=" bg-white h-full flex flex-col relative">
                            ...
                            <div class="w-full flex justify-end"> 
                                <button @click="showSideBar=false" aria-label="Search button" class="item p-3 rounded-full m-1 transition-all ease-in-out delay-150 hover-bg">
                ...
                <div class="w-full">  
                    <div class="bg-white">
                        ...
                        <div class="p-2 flex justify-center items-center flex-wrap w-full">
                            <!-- chivron left -->
                             <button class="mx-2 p-3 flex items-center transition-all ease-in-out delay-150 rounded-full box-shadow border-2 bg-primary-border scale" @click="getItems(paginate.current_page-1)">
