<template>
  <div class="container">
    <div class="m-2">
      <h2 class="text-2xl">{{ $settings.sections.blogs.title  }}</h2>
    </div>
    ...
    <div class="flex justify-center" v-if="$settings.sections.blogs.show_more_text">
      <nuxt-link class="flex items-center w-full px-4 py-2 mx-2 bg-white rounded shadow hover:bg-gray-50 text-primary" to="/blog">
        <span class="w-full">{{ $settings.sections.blogs.show_more_text }}</span>
