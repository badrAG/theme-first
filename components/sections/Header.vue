<template>
    <div>
        ...
        <div v-if="section.logo || section.icons.cart || section.icons.wishlist || section.icons.account || section.icons.search || section.icons.language || section.icons.currency || section.menu" class="border-b-2 header-bg header-text-color" :class="menu ? 'res-p' : 'py-2'">
