    ...
    <div class="header-bg header-text-color py-2 border-b-2">
        <header class="container flex items-center justify-between w-full ">
            ...
            <div class="mx-4">
                ...
                <div class="logo">
                    <router-link to="/">
                        <si-image width="70" height="50" property="height" class="h-8 md:h-10 lg:h-12 w-full object-contain" :src="section.logo ? section.logo.src : $store.state.defaults.logo" alt="Store logo"/>
                    </router-link>
                </div>
                <!-- logo -->
            </div>
                                    ...
                                    <div class="pb-1" v-for="(item,i) in item.childrens" :key="i" >
                                        ...
                                        <ul v-if="item.childrens && item.childrens.length > 0">
                                            <li class="px-2 pt-1" v-for="(child,ii) in item.childrens" :key="ii">
                                                <a class="text-sm hover:underline" :href="child.url">
                                                    > {{ child.text }}
                                                </a>
                                            </li>
                                        </ul>
