<template>
  <div class="">
    <div class="container pb-6 pt-4">
      ...
      <div class="container">
      <div v-if="!loading && collections.length==0" class="flex flex-wrap items-center  bg-white p-2 mx-4 border rounded-xl box-shadow">
      ...
      <div class="w-full md:w-1/2 align-center mt-4 md:mt-0 flex items-center justify-center">
          <div>
