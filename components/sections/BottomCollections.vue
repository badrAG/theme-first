<template>
    <div class="container py-6 ">
        ...
        <div class="p-2 px-4 mb-4" v-show="$settings.sections.bottom_collections.title.length > 0">
            <h3 class="text-xl font-bold align-center md:text-2xl">{{ $settings.sections.bottom_collections.title }}</h3>
        </div>
        <div class="px-2">
            <ul class="flex flex-wrap justify-center">
                <li class="w-1/2 p-2 md:w-1/3 lg:w-1/5" v-for="(item,i) in items" :key="i" >
        ...
        <div v-if="!loading && items.length==0" class="flex flex-wrap items-center p-2 mx-4 bg-white border rounded-xl">
